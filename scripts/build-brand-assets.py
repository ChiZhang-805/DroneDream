...
def build_outputs() -> dict[Path, bytes]:
        ...
        for edition_id in EDITION_IDS:
            ...
            if edition_id == "universal":
                ...
                validate_centered_separator(
                    ...
                    edition_id,
                    contract["approvedEditionAssets"][edition_id].get(
                        "separatorTolerancePx",
    ...
    for edition_id in EDITION_IDS[1:]:
        ...
        superseded_large = descriptor.get("supersededLargeLabelLockup")
        if superseded_large is not None:
            ...
            if (
                ...
                raise BrandBuildError(
                    f"superseded large-label lockup evidence drifted: {edition_id}"
                )
        ...
        if superseded_large is not None:
            approved_asset_records[edition_id]["supersededLargeLabelLockup"] = superseded_large
