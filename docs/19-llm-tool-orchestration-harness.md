...
1. `builtin-v1`, `px4-v1.16`, `px4-v1.17`, and `px4-main` all resolve to the
   stable built-in catalog bytes. Persisting the resolved built-in identity avoids
   falsely preserving the alias, but an old catalog
