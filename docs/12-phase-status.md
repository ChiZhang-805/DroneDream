...
- Versioned bilingual multicopter catalog with control-loop grouping, hard/safe
...
- Vehicle/PX4 profile, multi-objective definition, parameter selection, scenario
  matrix, 2D track editor, optimizer/provider choice, validation, review, and drafts.
...
- Fixed scenario matrices, common random numbers, weighted robust aggregation,
  hard/soft constraints, budget enforcement, renewable trial leases, and fencing.
