...
def verify_lab_preview_contract() -> dict[str, object]:
    ...
    if tuple(profile.get("labDeltaPaths", ())) != (
        ...
        "distribution/tests/test_lab_model_harness_contract.py",
        "distribution/tests/test_lab_sim_field_integration.py",
        ...
        "distribution/tools/verify_lab_model_harness_contract.py",
        "distribution/tools/verify_lab_sim_field_integration.py",
