...
$ProductSource = "392b6fbb5d301ebba1cea6971fa798627709bf46"
$ProductTree = "fd75d206559970f913b8ff0ec52b7dec1da951b1"
$SemanticFingerprint = "fa7523cb1a93b4b3626a3b9132139fea8ed7e2c165097a03545b2e58eaf68a91"
$ApplicationPath = Join-Path $PSScriptRoot "yellow-build-attempt-10-392b6fb-application.v1.json"
$EvidenceRoot = [IO.Path]::GetFullPath((Join-Path $PSScriptRoot "..\..\.."))
$SourceRoot = "C:\Users\zju20\dds10"
$RunRoot = "C:\Users\zju20\AppData\Local\DroneDream\codex-sandboxes\software-sim\yellow-2\sim-y2-ordinal10-392b6fb"
$ReceiptRoot = Join-Path $RunRoot "receipt"
$OutputRoot = Join-Path $RunRoot "bundle"
$NpmLogsRoot = Join-Path $ReceiptRoot "npm-logs"
$CargoTargetDir = "C:\Users\zju20\AppData\Local\DroneDream\codex-cache\sim-cargo-target-392b6fb-ordinal10"
$GlobalCacheRoot = "C:\Users\zju20\AppData\Local\npm-cache"
$SnapshotOwnedBase = "C:\Users\zju20\AppData\Local\DroneDream\codex-dependencies\npm-snapshots"
$SnapshotRoot = Join-Path $SnapshotOwnedBase "npm-snapshot-ordinal10-392b6fb"
$DependencyOwnedBase = "C:\Users\zju20\AppData\Local\DroneDream\codex-dependencies\npm"
$DependencyBundleId = "npm-win32-x64-ced4c28ea8e2fe84"
...
function Invoke-Prepare {
    ...
    Write-JsonFile ([ordered]@{ globalApplicationOrdinal = 10; preparationOrdinal = 1; buildOrdinal = 1; retry = 0 }) $AttemptLock
    ...
    Assert-True ((Get-Sha256Lower $sourceContractPath) -ceq $DependencyContractSha256) "Detached dependency contract module drifted."
    Assert-True ((Get-Sha256Lower $sourceAuthorityPath) -ceq $DependencyAuthoritySha256) "Detached dependency authority drifted."
