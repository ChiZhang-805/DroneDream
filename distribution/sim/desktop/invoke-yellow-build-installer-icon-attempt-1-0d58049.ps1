...
$ProductSource = "0d58049891cf61ab2de92ff013a563f496fc816e"
$ProductTree = "f66b9b65aac84d993b2d371928892ff95d6d3b87"
$SemanticFingerprint = "fa7523cb1a93b4b3626a3b9132139fea8ed7e2c165097a03545b2e58eaf68a91"
$ApplicationPath = Join-Path $PSScriptRoot "yellow-build-installer-icon-attempt-1-0d58049-application.v1.json"
$EvidenceRoot = [IO.Path]::GetFullPath((Join-Path $PSScriptRoot "..\..\.."))
$SourceRoot = "C:\Users\zju20\ddsi1"
$RunRoot = "C:\Users\zju20\AppData\Local\DroneDream\codex-sandboxes\software-sim\yellow-2\sim-installer-icon-attempt1-0d58049"
$ReceiptRoot = Join-Path $RunRoot "receipt"
$OutputRoot = Join-Path $RunRoot "bundle"
$NpmLogsRoot = Join-Path $ReceiptRoot "npm-logs"
$CargoTargetDir = "C:\Users\zju20\AppData\Local\DroneDream\codex-cache\sim-cargo-target-0d58049-installer-icon-attempt1"
$GlobalCacheRoot = "C:\Users\zju20\AppData\Local\npm-cache"
$SnapshotOwnedBase = "C:\Users\zju20\AppData\Local\DroneDream\codex-dependencies\npm-snapshots"
$SnapshotRoot = Join-Path $SnapshotOwnedBase "npm-snapshot-installer-icon-attempt1-0d58049"
$DependencyOwnedBase = "C:\Users\zju20\AppData\Local\DroneDream\codex-dependencies\npm"
$DependencyBundleId = "npm-win32-x64-0d580498f3c80c2e"
...
function Invoke-Prepare {
    ...
    Write-JsonFile ([ordered]@{ globalApplicationOrdinal = 18; preparationOrdinal = 1; buildOrdinal = 1; retry = 0 }) $AttemptLock
