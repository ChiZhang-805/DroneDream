...
$ApplicationName = "yellow-build-attempt-5-2bffcb0-application.v1.json"
$EvidenceRoot = [IO.Path]::GetFullPath((Join-Path $PSScriptRoot "..\..\.."))
$ApplicationPath = Join-Path $PSScriptRoot $ApplicationName
$RunRoot = "C:\Users\zju20\AppData\Local\DroneDream\codex-sandboxes\software-sim\yellow-2\sim-y2-ordinal5-2bffcb0"
$SourceRoot = "C:\Users\zju20\dds5"
...
function Invoke-ExactBuild {
    ...
    Write-JsonFile ([ordered]@{
        productSourceCommit = $ProductSource
        globalAuthorizedCommandOrdinal = 5
        sourceApplicationPreflightOrdinal = 3
