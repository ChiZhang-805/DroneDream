...
$ProductTree = "c6ac1549c352b4331d9d94e78a0b2e8662690023"
$SemanticFingerprint = "fa7523cb1a93b4b3626a3b9132139fea8ed7e2c165097a03545b2e58eaf68a91"
$ApplicationPath = Join-Path $PSScriptRoot "yellow-build-attempt-15-79a718d-application.v1.json"
$EvidenceRoot = [IO.Path]::GetFullPath((Join-Path $PSScriptRoot "..\..\.."))
$SourceRoot = "C:\Users\zju20\dds15"
$RunRoot = "C:\Users\zju20\AppData\Local\DroneDream\codex-sandboxes\software-sim\yellow-2\sim-y2-ordinal15-79a718d"
$ReceiptRoot = Join-Path $RunRoot "receipt"
$OutputRoot = Join-Path $RunRoot "bundle"
$NpmLogsRoot = Join-Path $ReceiptRoot "npm-logs"
$CargoTargetDir = "C:\Users\zju20\AppData\Local\DroneDream\codex-cache\sim-cargo-target-79a718d-ordinal15"
$GlobalCacheRoot = "C:\Users\zju20\AppData\Local\npm-cache"
$SnapshotOwnedBase = "C:\Users\zju20\AppData\Local\DroneDream\codex-dependencies\npm-snapshots"
$SnapshotRoot = Join-Path $SnapshotOwnedBase "npm-snapshot-ordinal15-79a718d"
$DependencyOwnedBase = "C:\Users\zju20\AppData\Local\DroneDream\codex-dependencies\npm"
$DependencyBundleId = "npm-win32-x64-0e9c69e8ce2eaff5"
...
function Invoke-Prepare {
    ...
    Write-JsonFile ([ordered]@{ globalApplicationOrdinal = 15; preparationOrdinal = 1; buildOrdinal = 1; retry = 0 }) $AttemptLock
