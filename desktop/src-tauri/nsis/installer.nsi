...
Function PageLeaveReinstall
  ...
  reinst_uninstall:
    ...
    ${Else}
      ...
      !ifmacrodef DRONEDREAM_APPEND_UNINSTALL_QUIESCE
        !insertmacro DRONEDREAM_APPEND_UNINSTALL_QUIESCE
      !endif
...
; 7. Optional DroneDream runtime mode page (fresh interactive installs only)
!ifmacrodef DRONEDREAM_RUNTIME_MODE_PAGE
  !insertmacro DRONEDREAM_RUNTIME_MODE_PAGE
!endif
...
Function RunMainBinary
  !ifmacrodef DRONEDREAM_BEFORE_RUN_MAIN_BINARY
    !insertmacro DRONEDREAM_BEFORE_RUN_MAIN_BINARY
  !endif
...
Function .onInit
  ...
  !ifmacrodef DRONEDREAM_ONINIT
    !insertmacro DRONEDREAM_ONINIT
  !endif
...
Function .onInstSuccess
  !ifmacrodef DRONEDREAM_ONINSTSUCCESS
    !insertmacro DRONEDREAM_ONINSTSUCCESS
  !endif
