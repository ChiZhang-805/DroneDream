...
const checks = [
  ...
  ["SIM artifact contract", /sim: \["autonomy_mission_plan", "external_asset_qualification_plan", "simulation_experiment"\]/u.test(edge)],
  ...
  ["FIELD artifact contract", /field: \["autonomy_mission_plan", "external_asset_qualification_plan", "field_task_plan"\]/u.test(edge)],
