...
function formToRequest(form: FormState): JobCreateRequest {
  ...
  const req: JobCreateRequest = {
    ...
    reference_track: generatedTrack ?? null,
    baseline_parameters: {
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        >
          <div className="form-grid">
            ...
            >
              <input id="display_name" value={form.display_name} onChange={handleTextChange("display_name")} />
            </Field>
            <Field
              label="Track Type"
              required
            ...
            {form.simulator_backend === "real_cli" && runtimeState ? (
              <>
                ...
                {runtimeState.mode_advisory ? (
                  <Alert tone="info">Gazebo real mode may run, but the web live-view iframe is not configured.</Alert>
                ) : null}
