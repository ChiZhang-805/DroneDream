...
const content = {
  en: {
    ...
    downloadWindows: "Download Windows preview",
    ...
    manualChapters: [
      ...
      ["2 · Install the desktop application", ["Download the versioned preview EXE from this page and verify its SHA-256.", "Run the installer, choose one interface language, and keep the recommended application folder.", "This preview candidate is not yet Authenticode-signed, so SmartScreen may require More info → Run anyway."]],
    ...
    released: "Released",
    footerLine: "Agentic PX4/Gazebo parameter optimization · Windows 1.0.0.",
  ...
  "zh-CN": {
    ...
    heroLead: "让调优有章法",
    heroAccent: "让飞行更加从容",
    downloadWindows: "下载 Windows 预览版",
    explore: "了解工作方式",
    releasePrefix: "版本",
    system: "Windows 10 / 11 · x64",
    ...
    manualChapters: [
      ...
      ["2 · 安装桌面程序", ["从本页下载带版本号的预览版 EXE，并先核对 SHA-256。", "运行安装器，选择一种界面语言，并保留推荐的应用程序目录。", "当前预览候选版本尚未完成 Authenticode 签名；SmartScreen 出现时需要选择“更多信息”并确认运行。"]],
    ...
    platformValue: "Windows x64",
    released: "发布日期",
    footerLine: "智能体驱动的 PX4/Gazebo 参数优化 · Windows 1.0.0。",
