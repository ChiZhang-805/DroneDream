...
const developmentFallbackRelease: WebsiteRelease = {
  ...
  downloadUrl: "https://github.com/ChiZhang-805/DroneDream/releases/download/five-edition-v1.0.0-build-1825/DroneDream-Universal_1.0.0_x64-setup.exe",
  checksumUrl: "https://github.com/ChiZhang-805/DroneDream/releases/download/five-edition-v1.0.0-build-1825/DroneDream-Universal_1.0.0_x64-setup.exe.sha256",
