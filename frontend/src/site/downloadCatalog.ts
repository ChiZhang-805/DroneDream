...
const RELEASE_BASE =
  "https://github.com/ChiZhang-805/DroneDream/releases/download/five-edition-v1.0.0-build-1805";
...
export const headerDownloadCatalog = [
  ...
  },
  {
    ...
    sizeBytes: 82_558_808,
    sha256: "5b8d4262454afa5a123e9eb7459d416c72e840b5ea0766b2cbb7fbee392fc20d",
    mark: simMark,
  },
  {
    id: "lab",
    ...
    sizeBytes: 83_081_639,
    sha256: "9f90033c0cc329b3b1797e5616927acfe4cf21d9fb1788f376eb268131fa1f52",
    mark: labMark,
  },
  {
    id: "field",
    ...
    sizeBytes: 82_801_654,
    sha256: "0c059df27634cd30d13a852d68e19d31440b5e58b0b4c2f089f967000fe737ee",
    mark: fieldMark,
  },
  {
    id: "autonomy",
    ...
    sizeBytes: 82_988_204,
    sha256: "8069bc36e9f6ab697256ac17e88e9396f6047c7635b887e6d90199a2a8d78f86",
    mark: autonomyMark,
  },
].map((download) => ({
  ...download,
