...
$sourceRoot = "C:\Users\zju20\ddf323"
$runRoot = "C:\Users\zju20\.codex\visualizations\2026\08\05\019fd0e2-71cc-7742-bfab-612510f37c39\field-yellow-build-323fd05-fresh-replacement"
$outputRoot = Join-Path $runRoot "artifact"
$cargoTarget = "C:\Users\zju20\AppData\Local\DroneDream\codex-cache\field-cargo-target\323fd05"
$expectedHead = "323fd05313527c0edec481d7e09acb5ac4735d22"
$expectedEvidenceHead = "c4313c87203cd200432683351ae7fae7e2b83376"
$applicationPath = "C:\Users\zju20\.codex\visualizations\2026\08\05\019fd0e2-71cc-7742-bfab-612510f37c39\field-yellow-readiness-323fd05-fresh-replacement\yellow-build-application.json"
$applicationSha256 = "3b3334b56e5feb362c2f599777fa69190a4113598da5a094a5e3a30ce49a5ecc"
$applicationFileSha256 = "40b6e3c2bcca8afe4e11858fccc30d12456566afd2139b5de0de4d19708fba92"
...
$overlayPath = Join-Path $sourceRoot "desktop\src-tauri\target\field-yellow-authorized-323fd05.json"
...
Assert-Contract ((Split-Path -Leaf $cargoTargetFull) -ceq "323fd05") `
...
$overlay.build.frontendDist = "../../../frontend/field-dist"
$overlay.bundle.icon = @($overlay.bundle.icon | ForEach-Object { "../$_" })
$relocatedResources = [ordered]@{}
foreach ($resource in $overlay.bundle.resources.PSObject.Properties) {
    $relocatedSource = if ($resource.Name -ceq "icons/icon.ico") {
        "../icons/icon.ico"
    } else {
        "../$($resource.Name)"
    }
    $relocatedResources[$relocatedSource] = $resource.Value
}
$overlay.bundle.resources = [pscustomobject]$relocatedResources
...
$donorFiles = [ordered]@{
    ...
    "distribution\tests\test_shared_windows_build_contract.py" = "e936ff7b24edb6be34a707bb7cd8a8c03a23e883fc7af6ff94ba68c05e965807"
}
...
$donorReleaseDriverBlob = (& git -C $sourceRoot rev-parse "f2858e3d2e39f493baab28368b77230e45dd199f:desktop/scripts/release-build-driver.psm1").Trim()
...
$overlayForComparison.build.frontendDist = $fieldConfig.build.frontendDist
$overlayForComparison.bundle.icon = $fieldConfig.bundle.icon
$overlayForComparison.bundle.resources = $fieldConfig.bundle.resources
...
Assert-Contract ($normalizedSource -ceq $normalizedRoundTrip) `
    "Tauri authorization overlay changes more than beforeBuildCommand and path-neutral relocation."
...
$receipt = [ordered]@{
    ...
    configuration = [ordered]@{
        ...
        overlayOnlySemanticChange = "build.beforeBuildCommand=npm run frontend:field-build; relative paths relocated without changing resolved targets"
    }
    resources = [ordered]@{
