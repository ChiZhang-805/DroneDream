...
\begin{tabular}{@{}L{0.32\linewidth}C{0.19\linewidth}L{0.36\linewidth}@{}}
\toprule
...
service changes cannot be permanently prevented. The gate therefore
  ...
  dependency under the same receipted probe sequence.
...
fallback campaign matches the direct arm in 10/10 frozen comparisons
  ...
  presentation-layer bytes or customer-facing claims.
...
not provider, PX4/Gazebo, or flight behavior. Each reproducible value
  ...
  complete build, visual review, and validation receipt.
