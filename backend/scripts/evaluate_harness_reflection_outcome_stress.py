"""Freeze or check the AURORA long-horizon reflection outcome stress test."""
...
def render_harness_reflection_outcome_stress_files(
...
def write_harness_reflection_outcome_stress_files(
    *,
    json_path: Path,
    csv_path: Path,
    manifest_path: Path,
    ...
    return {
        ...
        "primary_contrast": current_artifact["contrast_summaries"][
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Rerun all arms, independently recompute hashes and summaries, "
            "and require byte-identical frozen files."
        ),
    )
...
def main() -> int:
    args = _parse_args()
    result = write_harness_reflection_outcome_stress_files(
