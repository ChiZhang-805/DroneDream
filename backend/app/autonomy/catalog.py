    ...
    "school-campus-v1": TerrainScene(
        ...
        objects=[
            ...
            TerrainObject(
                ...
                kind="road",
                center=Vector3(x=0.0, y=-18.0, z=0.1),
                size=Vector3(x=104.0, y=31.0, z=0.2),
                traversable=True,
        ...
        reference_path=[
            ...
            _p(-24.8, 3.0, 1.35, "transit", 0.7),
            _p(-12.0, -16.0, 1.7, "transit", 1.1),
            _p(18.0, -18.0, 1.8, "transit", 1.2),
            _p(38.0, -3.0, 1.6, "transit", 0.9),
            _p(48.5, 0.4, 1.15, "pickup", 0.4),
            _p(38.0, -3.0, 1.6, "return", 0.85),
            _p(16.0, -18.0, 1.85, "return", 1.0),
            _p(-16.0, -12.0, 1.75, "return", 0.9),
            _p(-24.8, 3.0, 1.35, "return", 0.7),
