...
SCENES: dict[str, TerrainScene] = {
    "school-campus-v1": TerrainScene(
        ...
        reference_path=[
            ...
            _p(OFFICE_DOOR_CENTER_X, 11.0, 8.15, "transit", 0.3),
            _p(OFFICE_DOOR_CENTER_X, 9.75, 8.15, "transit", 0.3),
            ...
            *[
            ...
            _p(OFFICE_DOOR_CENTER_X, 9.75, 8.15, "return", 0.3),
            _p(OFFICE_DOOR_CENTER_X, 11.0, 8.15, "return", 0.3),
