"""Public connector catalog for external simulation-asset authoring tools.

DroneDream validates and qualifies imported assets; it does not present itself
as a general-purpose CAD or DCC modeler.  Native projects remain outside the
server process and must cross an isolated companion or plugin boundary before
they can become an inert ``.ddpkg`` package.
"""
...
from app.autonomy.models import StrictModel
