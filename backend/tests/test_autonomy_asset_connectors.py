...
def test_third_party_connector_cannot_claim_core_parser_or_enabled_state() -> None:
    payload = {
...
def test_connector_catalog_endpoint_preserves_the_standard_envelope(client: TestClient) -> None:
